    ...
    <>
      ...
      <section id="Gallery" className="-mb-[50px]">
        <div className="swiper w-full">
          <Swiper direction="horizontal" spaceBetween={0} slidesPerView="auto" slidesOffsetAfter={0} slidesOffsetBefore={0}>
        ...
        <div className="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
          ...
          <div className="overflow-hidden w-full h-[280px]">
            <div id="my-map-display" className="h-full w-full max-w-[none] bg-none">
              <iframe className="h-full w-full border-0" frameBorder={0} src={`https://www.google.com/maps/embed/v1/place?q=${encodeURIComponent(office.address)}&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8`} />
            </div>
